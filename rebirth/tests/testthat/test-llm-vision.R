...
# Shared helpers (synthetic_model_path, qwen_model_path, vision_fixture,
# vlm_model_path, vlm_mmproj_path) live in helper-llm.R. The T2
# llm_embed(images=) surface is tested in test-llm-vision-embed.R.
