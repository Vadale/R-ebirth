...
- **Why:** `nanoarrow` is purpose-built for lightweight, lazy Arrow reading — a small C core with
  ...
  reader role and the `SOLO-PHASE-PLAN.md` stack-table intent (naming a dep there is
